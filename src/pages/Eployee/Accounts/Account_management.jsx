                  ...
                  <div className="max-w-5xl mx-auto px-4">
                        ...
                        <div className="flex border-b border-gray-200 mb-6">
                              <button
                                    ...
                                    className={`py-2 px-4 font-medium text-sm ${activeTab === "profile" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-gray-700"
                                          }`}
                              >
                                    Profile
                              </button>
                              <button
                                    ...
                                    className={`py-2 px-4 font-medium text-sm ${activeTab === "update" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-gray-700"
                                          }`}
                              >
                                    Update Profile
                              </button>
